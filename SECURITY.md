...
At Gaia, the security of your data and the integrity of our platform are absolute priorities. We are deeply committed to protecting your information and providing a secure online environment for all our users.
...
If you discover a security vulnerability in any part of the Tarsi project, please **do not create a public issue**. Instead, **report it immediately** to the email [security@tarsi.9aia.com](mailto:security@tarsi.9aia.com).
...
We value the contributions of the security community to keep Tarsi secure. All legitimate reports will be thoroughly investigated and addressed with appropriate urgency.

## 2. Supported Versions

To ensure maximum security, only the **latest production version** of Tarsi is officially supported and receives continuous security updates.
